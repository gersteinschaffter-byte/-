...
async function deepseekAnalyze(opts) {
    const res = await fetch('https://api.deepseek.com/chat/completions', {
        ...
        body: JSON.stringify({
            ...
            messages: [
                {
                    role: 'system',
                    content: '你是资深游戏QA+工程师。只基于我提供的REPORT/SNAPSHOT/LOG分析，禁止臆测。' +
...
export default class AITestScene extends BaseScene {
    constructor(game) {
        ...
        Object.defineProperty(this, "btnCopy", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "btnDiag", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "btnAi", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "btnClearKey", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.preview.style.wordWrap = true;
        this.preview.style.wordWrapWidth = 680;
    ...
    getOrAskKey() {
        ...
        const v = window.prompt('请输入 DeepSeek API Key（仅本次会话缓存，不写存档）:', '');
    ...
    openTextModal(title, text) {
        ...
        content.style.wordWrapWidth = w - 90;
    ...
    onResize(w, h) {
        ...
        this.preview.style.wordWrapWidth = w - 120;
    }
}
