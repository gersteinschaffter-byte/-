...
export default class HomeScene extends BaseScene {
    constructor(game) {
        ...
        Object.defineProperty(this, "stageText", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "directorText", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "btnSummon", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "btnHeroes", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "btnBag", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "btnBattle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "unlistenStage", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.directorText.style.wordWrap = true;
        this.directorText.style.align = 'center';
    ...
    applySingleLineEllipsis(t, maxW) {
        if (!t)
            return;
        if (t.width <= maxW)
            return;
    ...
    onResize(w, h) {
        ...
        this.directorText.style.wordWrapWidth = Math.max(200, w - 80);
        this.stageText.style.wordWrap = false;
        this.stageText.style.wordWrapWidth = w - 80;
