 ...
 */
export function spawnFlashLine(parent, x0, y0, x1, y1, runner, opts) {
    ...
    runner.add(Tween.to(line, { alpha: 1 }, inFrames, (t) => t, () => {
        runner.add(Tween.to(line, { alpha: 0 }, outFrames, (t) => t, () => {
            line.destroy();
        }));
    }));
}
