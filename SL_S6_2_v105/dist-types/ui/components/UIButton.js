...
function makeGradientTexture(w, h, topColor, bottomColor, radius) {
...
function makeHighlightTexture(w, h, radius) {
    const canvas = document.createElement('canvas');
    canvas.width = Math.max(1, Math.round(w));
    canvas.height = Math.max(1, Math.round(h));
    const ctx = canvas.getContext('2d');
...
export default class UIButton extends Container {
    constructor(label, w = 260, h = 86) {
        ...
        Object.defineProperty(this, "_pressed", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "borderLayer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        }); // 金属边框
        Object.defineProperty(this, "highlightSprite", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "innerShadow", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "normalTex", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "hoverTex", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "pressedTex", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "highlightTex", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    buildTextures(radius) {
        ...
        // Pressed 渐变（反转：暗→亮）
        this.pressedTex = makeGradientTexture(w, h, darken(buttonFace.bottom, 0.2), lighten(buttonFace.top, 0.05), radius);
        // 高光条（上半部分）
    ...
    draw() {
        ...
        if (!isDisabled && !isPressed) {
            ...
            for (const layer of glowLayers) {
                ...
                roundedRect(this.glow, -layer.expand, -layer.expand, w + layer.expand * 2, h + layer.expand * 2, radius + layer.expand * 0.5);
            }
            // Hover 时额外加一层内侧柔光
            if (isHover) {
        ...
        if (isDisabled) {
            this.txt.style.fill = colors.text.disabled;
        }
        else if (isPressed) {
            // 按下时文字微微下移 1px（物理反馈）
            this.txt.position.set(this.w / 2, this.h / 2 + 1);
            this.txt.style.fill = colors.text.secondary;
        }
        else {
            this.txt.position.set(this.w / 2, this.h / 2);
            this.txt.style.fill = colors.text.primary;
        }
    }
    // ── 销毁 ──
    destroy() {
