...
export default class Modal extends Container {
    constructor(w, h, ticker) {
        ...
        Object.defineProperty(this, "btnClose", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.content.removeChildren = (..._args) => {
            throw new Error('[Modal] Forbidden: do not call modal.content.removeChildren(). ' +
     ...
     * - opens modal
     */
    openLayer(name, build, clear = true) {
